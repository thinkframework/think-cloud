package io.github.thinkframework.cloud.client.discovery.stomp;
...
import io.github.thinkframework.cloud.client.discovery.InstanceConfig;
...
public class StompDiscoveryClient implements DiscoveryClient {

    private static final Logger logger = LoggerFactory.getLogger(StompDiscoveryClient.class);
    ...
    public StompDiscoveryClient(ClientConfig clientConfig,

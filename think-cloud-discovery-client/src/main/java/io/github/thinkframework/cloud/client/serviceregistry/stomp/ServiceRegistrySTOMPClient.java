package io.github.thinkframework.cloud.client.serviceregistry.stomp;
...
public class ServiceRegistrySTOMPClient implements ServiceRegistryClient {

    private static final Logger logger = LoggerFactory.getLogger(ServiceRegistrySTOMPClient.class);
    ...
    public ServiceRegistrySTOMPClient(ClientConfig clientConfig) {

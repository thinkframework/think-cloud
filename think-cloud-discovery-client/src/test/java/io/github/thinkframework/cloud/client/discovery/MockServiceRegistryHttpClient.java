 ...
 * 单元测试用的服务注册发现客户端
 */
public class MockServiceRegistryHttpClient implements ServiceRegistryHttpClient {

    private static final Logger logger = LoggerFactory.getLogger(ServiceRegistryHttpClient.class);

    private Registration registration;

    public MockServiceRegistryHttpClient(Registration registration) {

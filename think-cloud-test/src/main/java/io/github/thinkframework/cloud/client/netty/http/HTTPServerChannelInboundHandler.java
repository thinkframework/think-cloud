 ...
 * 调试用
 */
public class HTTPServerChannelInboundHandler extends SimpleChannelInboundHandler<FullHttpRequest> {

    protected final Logger log = LoggerFactory.getLogger(HTTPServerChannelInboundHandler.class);
